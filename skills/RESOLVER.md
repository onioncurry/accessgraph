...
| skill | when to use |
|---|---|
| [task_access_assistant](task_access_assistant/SKILL.md) | A task is assigned in Slack/Teams and someone (human or agent) needs to know the minimum access package required to complete it. Also: "what access does X need", "@AccessBot". |
